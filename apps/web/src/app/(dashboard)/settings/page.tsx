...
const SECTIONS: SectionMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'amazonCategoryUrls', label: 'Amazon URLs diretas (RECOMENDADO)', type: 'textarea', placeholder: 'https://www.amazon.com.br/s?i=electronics&s=exact-aware-popularity-rank, https://www.amazon.com.br/s?i=home&s=exact-aware-popularity-rank', hint: 'IMPORTANTE: actor só aceita /s?i=cat ou /s?k=keyword ou /dp/ASIN ou /b?node=. NÃO aceita /gp/goldbox nem /gp/bestsellers. Categorias válidas i=: electronics, home, kitchen, sports, health-personal-care, automotive, computers, baby, books, toys, beauty, fashion, pet-supplies, garden, office-products. Sufixo &s=exact-aware-popularity-rank ordena por popularidade.' },
