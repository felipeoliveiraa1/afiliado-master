...
export const ML_CATEGORIES: MlCategory[] = [
  { id: 'MLB5672', name: 'Acessórios para Veículos', emoji: '🚗', children: [
  ...
  { id: 'MLB1071', name: 'Animais', emoji: '🐾', children: [
    { id: 'MLB1075', name: 'Cachorros' },
    { id: 'MLB1077', name: 'Gatos' },
    { id: 'MLB1081', name: 'Pássaros' },
    { id: 'MLB1086', name: 'Peixes' },
  ]},
  { id: 'MLB1367', name: 'Antiguidades e Coleções', emoji: '🏺' },
  { id: 'MLB1368', name: 'Arte, Papelaria e Armarinho', emoji: '🎨', children: [
    { id: 'MLB1370', name: 'Materiais Escolares' },
    { id: 'MLB1372', name: 'Artesanato' },
  ]},
  { id: 'MLB1384', name: 'Bebês', emoji: '🍼', children: [
  ...
  { id: 'MLB1246', name: 'Beleza e Cuidado Pessoal', emoji: '💄', children: [
  ...
  { id: 'MLB1132', name: 'Brinquedos e Hobbies', emoji: '🧸', children: [
  ...
  { id: 'MLB1430', name: 'Calçados, Roupas e Bolsas', emoji: '👔', children: [
  ...
  { id: 'MLB1499', name: 'Ferramentas', emoji: '🔨', children: [
    { id: 'MLB272029', name: 'Ferramentas Elétricas' },
    { id: 'MLB272030', name: 'Ferramentas Manuais' },
  ]},
  { id: 'MLB1953', name: 'Festas e Lembrancinhas', emoji: '🎉' },
  { id: 'MLB1144', name: 'Games', emoji: '🎮', children: [
    { id: 'MLB1146', name: 'Consoles e Vídeo Games' },
    { id: 'MLB1148', name: 'Jogos para Consoles' },
    { id: 'MLB186456', name: 'Acessórios para Consoles' },
  ]},
  { id: 'MLB1500', name: 'Indústria e Comércio', emoji: '🏭' },
  { id: 'MLB1648', name: 'Informática', emoji: '💻', children: [
  ...
  { id: 'MLB3937', name: 'Joias e Relógios', emoji: '💎', children: [
